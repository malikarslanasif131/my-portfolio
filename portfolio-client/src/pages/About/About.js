        ...
        <div id="about_me" className="container my-5 ">
          ...
          <div className="row my-5">
            ...
            <div className="col-md-8 m-auto about__card">
              ...
              <div className="mx-5 about_detail-sec">
                <p className="about_details mt-5 about_first-p">
                  ...
                  <b className="fs-3 mern-color">MERN Stack</b>. My journey
                  began by honing my proficiency in HTML, CSS, and JavaScript.
                  On the frontend, I've worked extensively with frameworks such
                  as React.js and Next.js, while on the backend, I've utilized
                  Node.js, Express.js, and PHP to bring projects to life.
                </p>
                <p className="about_details">
                  ...
                  Additionally, I am an expert in CMS (Content Management
                  System) platforms, particularly Drupal, which shares
                ...
                <p className="about_details">
                  ...
                  frontend and backend aspects of projects. To enhance the
                  visual and functional aspects, I leverage CSS frameworks like
                  Bootstrap and Tailwind CSS, along with React CSS libraries
                  such as Material UI, React Bootstrap, and Ant Design.
                </p>
                <div className="my-3 ">
